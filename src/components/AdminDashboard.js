...
function AdminDashboard() {
    ...
    const loadData = async () => {
        try {
            ...
            const interviews = await axios.get("http://localhost:8081/interviews");
            const preparations = await axios.get("http://localhost:8081/preparations");
            const achievements = await axios.get("http://localhost:8081/achievements");
